...
export const HERO_SEQUENCE: TerminalLine[] = [
	...
	},
	{
		...
		type: "info",
		content:
			"The core authentication logic resides in SecurityService.ts, specifically the validateToken method...",
		delay: 8000,
	},
];
...
export const RESEARCH_LEVELS = [
	{
		...
		benefit:
			"Initial filtering, broad queries — achieves ~80% codebase reduction",
	},
	{
		level: "Class/Module",
	...
	},
	{
		...
		benefit:
			"Precise queries, code completion — 53% accuracy improvement in tests",
	},
];
