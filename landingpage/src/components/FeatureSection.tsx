    ...
    <div className="w-full h-full flex flex-col items-center justify-center p-8 bg-[#151515] border border-white/5 rounded-xl relative overflow-hidden">
        ...
        <div className="absolute z-20 flex flex-col items-center">
             ...
             <div className="text-gray-500 text-xs font-mono mt-4 text-center">
                 Session terminated.<br/>Context lost.
             </div>
        </div>
    </div>
);
...
const ContextTaxVisual: React.FC = () => (
    <div className="w-full h-full flex flex-col items-center justify-center p-8 bg-[#151515] border border-white/5 rounded-xl relative overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-end justify-center gap-1 opacity-30">
             {[...Array(10)].map((_, i) => (
                 <div key={i} className="w-2 bg-yellow-500/50 rounded-t-sm animate-flow-up" style={{ height: `${Math.random() * 100}%`, animationDuration: `${1 + Math.random()}s` }}></div>
             ))}
        </div>
        
        <div className="relative z-20 bg-[#0c0c0c] p-6 rounded-2xl border border-white/10 shadow-2xl text-center">
             <div className="text-gray-400 text-xs font-mono uppercase mb-2">Cost per session</div>
    ...
    <div className="w-full h-full flex flex-col items-center justify-center p-8 bg-[#151515] border border-white/5 rounded-xl relative overflow-hidden">
        <div className="grid grid-cols-2 gap-4 w-full max-w-sm">
             ...
             <div className="bg-[#0c0c0c] border border-red-900/50 p-4 rounded-lg relative overflow-hidden">
                 ...
                 <div className="absolute bottom-2 right-2 text-[8px] text-red-500 font-bold uppercase border border-red-500 px-1 rounded">Duplicate</div>
             </div>
    ...
    return (
        <section className="relative pt-32 pb-32 max-w-7xl mx-auto px-6">
            <div className="text-center mb-32">
                ...
                <p className="text-xl text-gray-500 font-medium">The hidden costs of stateless coding assistants.</p>
            </div>
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
                ...
                <div className="lg:w-1/2 space-y-[40vh] py-[10vh]">
                    ...
                    {/* Step 1 */}
                    <div ref={step1Ref} className={`transition-opacity duration-500 ${activeStep === 0 ? 'opacity-100' : 'opacity-30 blur-sm'}`}>
                        ...
                        <h3 className="text-4xl font-bold text-white mb-6">The Amnesia Loop</h3>
                        <p className="text-xl text-gray-400 leading-relaxed">
                            AI assistants are stateless. Close the tab, and they forget your architecture. 
                            Every new session triggers a slow, repetitive "discovery" phase where it reads the same files it read yesterday.
                        </p>
                    </div>

                    {/* Step 2 */}
                    <div ref={step2Ref} className={`transition-opacity duration-500 ${activeStep === 1 ? 'opacity-100' : 'opacity-30 blur-sm'}`}>
                        ...
                        <h3 className="text-4xl font-bold text-white mb-6">The Context Tax</h3>
                        <p className="text-xl text-gray-400 leading-relaxed">
                            You pay for this amnesia. Watch your logs: 60% of your tokens are burned just re-feeding context. 
                            You are paying double for half the actual coding work.
                        </p>
                    </div>

                    {/* Step 3 */}
                    <div ref={step3Ref} className={`transition-opacity duration-500 ${activeStep === 2 ? 'opacity-100' : 'opacity-30 blur-sm'}`}>
                        ...
                        <p className="text-xl text-gray-400 leading-relaxed">
                            Because it doesn't "know" your codebase, it guesses. It implements a utility that already exists 
                            in <code className="bg-gray-800 px-1 rounded text-gray-300">/lib</code>. Now you have duplicates, drift, and technical debt.
                        </p>
                    </div>
                ...
                <div className="lg:w-1/2 relative hidden lg:block">
                    <div className="sticky top-1/3 h-[500px] w-full bg-[#0c0c0c] border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                         ...
                         <div className={`absolute inset-0 transition-opacity duration-700 p-8 flex flex-col items-center justify-center ${activeStep === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                            <AmnesiaVisual />
                         </div>

                         {/* Visual 2: Context Tax */}
                         <div className={`absolute inset-0 transition-opacity duration-700 p-8 flex flex-col items-center justify-center ${activeStep === 1 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                            <ContextTaxVisual />
                         </div>

                         {/* Visual 3: Code Rot */}
                         <div className={`absolute inset-0 transition-opacity duration-700 p-8 flex flex-col items-center justify-center ${activeStep === 2 ? 'opacity-100 z-10' : 'opacity-0 z-0'}`}>
                            <CodeRotVisual />
                         </div>
                    </div>
                </div>
...
const ProblemSynthesisSection = () => {
    ...
    const features = [
        { id: 'critical', title: "Critical Paths", desc: "Identify production-critical flows.", icon: <BoltIcon />, color: "#f59e0b" },
        { id: 'dead', title: "Dead Code", desc: "Prune unused legacy functions.", icon: <SkullIcon />, color: "#9ca3af" },
        { id: 'connections', title: "Symbol Graph", desc: "Map dependencies across files.", icon: <LinkIcon />, color: "#38bdf8" },
        { id: 'patterns', title: "Team Patterns", desc: "Enforce idiomatic styles.", icon: <BrainIcon />, color: "#f472b6" },
        { id: 'intent', title: "True Intent", desc: "Understand purpose, not just syntax.", icon: <TargetIcon />, color: "#ef4444" },
        { id: 'duplication', title: "Deduplication", desc: "Find copy-pasted logic.", icon: <DnaIcon />, color: "#8b5cf6" },
    ];
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="mb-24 text-center">
                    <h3 className="text-4xl md:text-6xl font-black text-white mb-6 tracking-tight leading-tight">
                        Imagine if the AI <span className="text-[#00D4AA]">already knew</span>:
                    </h3>
                    <p className="text-gray-500 font-mono text-lg">
                        Claudemem pre-indexes your codebase so your agent doesn't have to guess.
                    </p>
                </div>
                    ...
                    <div className="lg:col-span-5 flex flex-col gap-2">
                        {features.map((feature, idx) => (
                            ...
                            >
                                ...
                                <div>
                                    <h4 className={`text-lg font-bold transition-colors ${activeFeature === idx ? 'text-white' : 'text-gray-400'}`}>
                                        {feature.title}
                                    </h4>
                    ...
                    <div className="lg:col-span-7">
                        <div className="bg-[#0c0c0c] border border-white/10 rounded-3xl h-[500px] md:h-[600px] relative overflow-hidden shadow-2xl flex flex-col">
                            ...
                            <div className="h-10 border-t border-white/5 bg-[#0f0f0f] px-6 flex items-center justify-between text-[10px] font-mono text-gray-500">
                                <div>status: <span className="text-claude-ish">online</span></div>
                                <div>mode: <span className="text-white">{features[activeFeature].id.toUpperCase()}_ANALYSIS</span></div>
                            </div>
                        </div>
                    </div>
                ...
                <div className="mt-24 text-center flex justify-center">
                    <div className="inline-flex items-center gap-3 bg-[#0a0a0a] px-6 py-3 rounded-full border border-white/10 shadow-2xl hover:border-claude-ish/50 transition-colors cursor-default">
                        <span className="text-gray-500 font-mono text-sm tracking-wide">Not re-learning it.</span>
                        <span className="text-gray-700 mx-1">•</span>
                        <span className="text-white font-bold font-mono text-sm tracking-wide">Knowing it instantly.</span>
                    </div>
                </div>
             ...
             <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-24 space-y-6">
                    ...
                    <p className="text-lg md:text-xl text-gray-400 font-mono max-w-3xl mx-auto leading-relaxed">
                        claudemem indexes your codebase once. Understands it deeply. Serves that understanding to AI agents instantly — session after session.
                    </p>
                    
                    {/* Enhanced Link */}
                    <div className="pt-8 flex justify-center">
                        <a href="https://arxiv.org/abs/2410.17435" target="_blank" rel="noreferrer" className="group flex items-center gap-4 bg-[#0a0a0a] border border-white/10 px-8 py-4 rounded-full hover:border-claude-ish/50 hover:bg-claude-ish/5 transition-all shadow-lg hover:shadow-claude-ish/10">
                            ...
                            <div className="flex flex-col text-left">
                                <span className="text-[10px] text-gray-500 uppercase tracking-widest font-bold group-hover:text-claude-ish transition-colors">Research Backed</span>
                                <span className="text-sm font-mono text-gray-300 group-hover:text-white">Based on <span className="underline decoration-claude-ish/50 underline-offset-4 decoration-2">JP Morgan's 2025 Meta-RAG Study</span></span>
                            </div>
                        ...
                        {RESEARCH_LEVELS.map((level, idx) => (
                            ...
                            >
                                ...
                                <div className="flex items-center justify-between mb-2">
                                    <h3 className={`text-xl font-bold font-mono ${activeLevel === idx ? 'text-white' : 'text-gray-400'}`}>
                                        {level.level}
                                    </h3>
                                    <div className={`text-xs font-black uppercase tracking-widest px-2 py-1 rounded ${activeLevel === idx ? 'bg-claude-ish text-black' : 'bg-gray-800 text-gray-500'}`}>
                                        Level 0{idx + 1}
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <div className="text-sm text-gray-300">
                                        <span className="text-gray-500 font-bold uppercase text-[10px] tracking-widest mr-2">Captures:</span>
                                        {level.capture}
                                    </div>
                                    <div className={`text-sm transition-colors ${activeLevel === idx ? 'text-claude-ish' : 'text-gray-500'}`}>
                                        <span className="text-gray-500 font-bold uppercase text-[10px] tracking-widest mr-2">Benefit:</span>
                                        {/* Auto-highlight percentages */}
                                        {level.benefit.split(/(~?\d+%)/).map((part, i) => 
                                            part.match(/~?\d+%/) 
                                                ? <span key={i} className="text-white bg-white/10 px-1.5 py-0.5 rounded font-black mx-1 inline-block border border-white/10">{part}</span> 
                                                : part
                                        )}
                                    </div>
                                </div>
                        ...
                        <div className="flex-1 relative flex items-center justify-center p-8">
                             ...
                             <div className="absolute inset-0 opacity-20 pointer-events-none">
                                 ...
                                 <svg className="w-full h-full">
                                     ...
                                     <line x1="20%" y1="20%" x2="80%" y2="80%" stroke="#fff" strokeWidth="0.5" strokeDasharray="4" />
                                 </svg>
                             </div>
                             ...
                             {activeLevel === 0 && (
                                 <div className="relative w-64 h-80 bg-[#151515] border border-gray-700 rounded-lg p-4 flex flex-col gap-4 animate-fadeIn shadow-2xl">
                                     ...
                                     <div className="space-y-2 font-mono text-[10px]">
                                         <div className="text-gray-500 uppercase tracking-widest">Imports</div>
                                         <div className="bg-gray-800/50 p-2 rounded text-blue-300">import {'{'} User {'}'} from './models';</div>
                                         <div className="bg-gray-800/50 p-2 rounded text-blue-300">import {'{'} Config {'}'} from '../config';</div>
                                         
                                         <div className="text-gray-500 uppercase tracking-widest mt-4">Exports</div>
                             ...
                             {activeLevel === 1 && (
                                 <div className="relative w-72 h-auto bg-[#1a1a1a] border-2 border-claude-ish/30 rounded-lg p-0 animate-fadeIn shadow-[0_0_30px_-5px_rgba(0,212,170,0.1)]">
                                     <div className="bg-claude-ish/10 px-4 py-2 border-b border-claude-ish/20 flex justify-between items-center">
                                         <span className="font-mono text-xs font-bold text-claude-ish">class AuthService</span>
                                     ...
                                     <div className="p-4 space-y-3 font-mono text-[11px]">
                                         ...
                                         <div className="flex items-center gap-2">
                                             ...
                                             <span className="ml-auto text-gray-500 italic">State</span>
                                         </div>
                                         <div className="flex items-center gap-2 bg-white/5 p-1 rounded -mx-1">
                                             <span className="text-purple-400 font-bold">+ validate(token)</span>
                                             <span className="ml-auto text-claude-ish text-[9px] uppercase tracking-wider font-bold">Primary Interface</span>
                                         </div>
                             ...
                             {activeLevel === 2 && (
                                 <div className="relative w-full max-w-sm animate-fadeIn">
                                     <div className="bg-[#111] p-5 rounded-lg border border-gray-800 font-mono text-[11px] leading-loose text-gray-400 relative overflow-hidden">
                                         ...
                                         <div><span className="text-purple-400">async function</span> <span className="text-yellow-400">validate</span>(token: string) {'{'}</div>
                                         <div className="pl-4"><span className="text-blue-400">if</span> (!token) <span className="text-purple-400">return</span> false;</div>
                                         <div className="pl-4"><span className="text-blue-400">try</span> {'{'}</div>
                                         <div className="pl-8 text-white bg-white/5 rounded px-1">const decoded = jwt.verify(token);</div>
                                         <div className="pl-8">return decoded.exp &gt; Date.now();</div>
                                         <div className="pl-4">{'}'} <span className="text-blue-400">catch</span> {'{'} <span className="text-purple-400">return</span> false; {'}'}</div>
                                         <div>{'}'}</div>
                                     </div>
                                     ...
                                     <div className="absolute top-1/2 right-[-20px] translate-x-full w-32 hidden lg:block">
                                        <div className="text-[10px] text-gray-500 mb-1 border-b border-gray-700 pb-1">AI Interpretation:</div>
                                        <div className="text-xs text-white">"Validates JWT expiration safely"</div>
                                     </div>
                                 </div>
                             )}
...
const FeatureDeepDive: React.FC = () => {
    ...
    const tabs = [
        { id: 'chunking', title: "Smart Code Chunking", subtitle: "AST-based Semantic Boundaries" },
        ...
        <section className="py-24 bg-[#050505] relative">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-4xl md:text-5xl font-black text-white mb-6">Engineered for Understanding</h2>
                    <p className="text-gray-500 font-mono text-lg">The technical architecture behind claudemem.</p>
                </div>
                    ...
                    <div className="lg:col-span-4 flex flex-col justify-center gap-2">
                        {tabs.map((tab, idx) => (
                            <button
                                ...
                                `}
                            >
                                <div className={`text-lg font-bold transition-colors ${activeTab === idx ? 'text-white' : 'text-gray-400'}`}>
                                    {tab.title}
                                </div>
                                <div className="text-xs font-mono text-gray-500 mt-1">{tab.subtitle}</div>
                                {activeTab === idx && (
...
const FeatureChunking = () => (
    <div className="flex flex-col gap-8 animate-fadeIn">
        <div>
            <h3 className="text-2xl font-bold text-white mb-2">Smart Code Chunking</h3>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
                Naive splitters cut code at character limits, breaking logic. We use <span className="text-claude-ish">Tree-sitter AST</span> to respect semantic boundaries, keeping functions and classes intact.
            </p>
        </div>
        <div className="relative border border-gray-800 bg-[#111] rounded-lg p-6 font-mono text-xs overflow-hidden">
            <div className="absolute top-0 right-0 bg-claude-ish text-[#050505] text-[10px] font-bold px-2 py-1">AST MODE</div>
            ...
            <div className="my-2 border border-blue-500/30 bg-blue-500/5 p-2 rounded relative">
                <div className="absolute -right-1 top-0 text-[9px] text-blue-400 bg-[#111] px-1 border border-blue-500/30 rounded">Chunk A</div>
                <div className="text-blue-300">  async validateUser(id: string) {'{'}</div>
            ...
            <div className="my-2 border border-green-500/30 bg-green-500/5 p-2 rounded relative">
                <div className="absolute -right-1 top-0 text-[9px] text-green-400 bg-[#111] px-1 border border-green-500/30 rounded">Chunk B</div>
                <div className="text-green-300">  private hashToken(t: string) {'{'}</div>
                <div className="pl-4 text-gray-500">// ... logic ...</div>
            ...
            <div className="absolute top-1/2 left-0 w-full h-[1px] bg-red-500/50 border-t border-dashed border-red-500 flex items-center justify-center">
                 <span className="bg-[#111] text-red-500 px-2 text-[10px] font-bold">NAIVE SPLIT WOULD CUT HERE</span>
            </div>
        </div>
    </div>
);
...
const FeaturePageRank = () => (
    <div className="flex flex-col gap-8 animate-fadeIn h-full justify-center">
         <div>
            <h3 className="text-2xl font-bold text-white mb-2">PageRank Importance</h3>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
                Not all code is equal. We build a dependency graph and run PageRank. Central nodes get higher relevance scores, solving the "dead code" problem.
            </p>
        </div>
        <div className="relative h-64 w-full flex items-center justify-center">
             ...
             <div className="absolute w-24 h-24 bg-claude-ish/20 rounded-full flex items-center justify-center border-2 border-claude-ish shadow-[0_0_30px_rgba(0,212,170,0.3)] z-20 animate-pulse">
                <div className="text-center">
                    <div className="text-[10px] font-bold text-claude-ish uppercase">Core</div>
             ...
             <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
                 <line x1="50%" y1="50%" x2="75%" y2="20%" stroke="#00D4AA" strokeWidth="2" strokeOpacity="0.3" />
                 <line x1="50%" y1="50%" x2="20%" y2="80%" stroke="#00D4AA" strokeWidth="1" strokeOpacity="0.3" />
                 <line x1="50%" y1="50%" x2="30%" y2="10%" stroke="#00D4AA" strokeWidth="1.5" strokeOpacity="0.3" />
             </svg>
        </div>
    </div>
);
...
const FeatureSummaries = () => (
    <div className="flex flex-col gap-8 animate-fadeIn">
        <div>
            <h3 className="text-2xl font-bold text-white mb-2">Intent-Based Summaries</h3>
            <p className="text-gray-400 leading-relaxed max-w-2xl">
        ...
        <div className="grid md:grid-cols-2 gap-4">
             <div className="bg-[#1a1a1a] border border-red-500/20 p-6 rounded-xl relative opacity-60">
                 <div className="absolute -top-3 left-4 bg-[#0c0c0c] px-2 text-[10px] font-bold text-red-500 border border-red-500/30 uppercase">Raw Implementation</div>
                 ...
                 <div className="mt-4 text-red-500 text-sm font-bold">❌ Low Retrieval Value</div>
             </div>

             <div className="bg-[#1a1a1a] border border-claude-ish/30 p-6 rounded-xl relative shadow-lg">
                 <div className="absolute -top-3 left-4 bg-[#0c0c0c] px-2 text-[10px] font-bold text-claude-ish border border-claude-ish/50 uppercase">Semantic Intent</div>
                 ...
                 <div className="mt-4 text-claude-ish text-sm font-bold">✅ High Retrieval Value</div>
             </div>
        </div>
    </div>
);
...
const FeatureHybrid = () => (
    <div className="flex flex-col gap-8 animate-fadeIn h-full justify-center">
        <div>
            ...
            <p className="text-gray-400 leading-relaxed max-w-2xl">
                Vector search misses keywords. Keywords miss meaning. We combine <span className="text-white">Vector + Keyword + PageRank</span> for the perfect match.
            </p>
        </div>
    ...
    <div className="flex flex-col gap-8 animate-fadeIn h-full justify-center items-center text-center">
        <div>
            ...
            <p className="text-gray-400 leading-relaxed max-w-md mx-auto">
                No cloud upload. No account required. Your code never leaves your machine.
            </p>
        </div>
                 ...
                 <div className="grid md:grid-cols-2 gap-16 items-center">
                     <div className="space-y-8">
                         ...
                         <h2 className="text-4xl md:text-6xl font-black text-white leading-tight">
                             Context Window <br/>
                             <span className="text-transparent bg-clip-text bg-gradient-to-r from-claude-ish to-blue-400">Liberation.</span>
                         </h2>
                         <p className="text-xl text-gray-400 leading-relaxed">
                             Stop wasting 50% of your context window on "exploration." With claudemem, the AI starts with understanding, leaving the full window for reasoning and code generation.
                         </p>
                     </div>
                     ...
                     <div className="bg-[#111] border border-gray-800 rounded-2xl p-8 shadow-2xl space-y-8">
                         ...
                         <div className="space-y-2">
                             ...
                             <div className="h-12 bg-gray-900 rounded-lg overflow-hidden flex text-[10px] font-bold text-white/80 uppercase tracking-wider">
                                 <div className="h-full bg-red-500/20 text-red-500 flex items-center justify-center border-r border-gray-900" style={{width: '60%'}}>
                                     Exploration Noise (60%)
                                 </div>
                                 <div className="h-full bg-gray-800 text-gray-500 flex items-center justify-center" style={{width: '40%'}}>
                                     Actual Work
                                 </div>
                             </div>
                         </div>
                         ...
                         <div className="space-y-2">
                             ...
                             <div className="h-12 bg-gray-900 rounded-lg overflow-hidden flex text-[10px] font-bold text-white/80 uppercase tracking-wider relative shadow-[0_0_30px_rgba(0,212,170,0.1)]">
                                 <div className="h-full bg-claude-ish flex items-center justify-center text-black" style={{width: '95%'}}>
                                     Pure Reasoning & Code Gen (95%)
                                 </div>
                                 <div className="h-full bg-blue-500 flex items-center justify-center" style={{width: '5%'}}>
                                 </div>
                             </div>
                         </div>
    ...
    <section className="py-32 bg-[#050505] border-t border-white/5 relative" id="benchmarks">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-32 items-center">
            <div className="space-y-6">
                <h3 className="text-3xl font-bold text-white">The Model Freedom Difference</h3>
        ...
        <div className="mb-32">
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                    ...
                    <p className="text-sm text-gray-400">Not just an MCP server. A full toolkit.</p>
                    <TerminalWindow title="terminal" className="h-64 bg-[#0a0a0a]" noPadding>
                        <div className="p-4 font-mono text-xs space-y-4 text-gray-300">
                            <div>
                                <div className="text-gray-500 mb-1"># Search from terminal</div>
                                <div><span className="text-claude-ish">$</span> claudemem search "payment"</div>
                            </div>
                            <div>
                                <div className="text-gray-500 mb-1"># See dependencies</div>
                                <div><span className="text-claude-ish">$</span> claudemem callers "validate"</div>
                            </div>
                            <div>
                                <div className="text-gray-500 mb-1"># Visualise PageRank</div>
                                <div><span className="text-claude-ish">$</span> claudemem map</div>
                            </div>
                        </div>
                    </TerminalWindow>
                </div>
                ...
                {/* 2. Any Model */}
                <div className="space-y-4">
                    <h4 className="text-xl font-bold text-white">2. Any model, anywhere</h4>
                    <p className="text-sm text-gray-400">Your stack. Your choice.</p>
                    <TerminalWindow title="config" className="h-64 bg-[#0a0a0a]" noPadding>
                        <div className="p-4 font-mono text-xs space-y-4 text-gray-300">
                            <div>
                                <div className="text-gray-500 mb-1"># Go fully local (Ollama)</div>
                                <div><span className="text-claude-ish">$</span> claudemem config --embeddings ollama/nomic --summarizer ollama/llama3</div>
                            </div>
                            <div>
                                <div className="text-gray-500 mb-1"># Or use Claude Code sub</div>
                                <div><span className="text-claude-ish">$</span> claudemem config --summarizer claude-code</div>
                            </div>
                        </div>
                    </TerminalWindow>
                </div>
                ...
                {/* 3. Benchmarks */}
                <div className="space-y-4">
                    <h4 className="text-xl font-bold text-white">3. Benchmarks included</h4>
                    <p className="text-sm text-gray-400">Not marketing claims. Measured results.</p>
                    <TerminalWindow title="benchmark" className="h-64 bg-[#0a0a0a]" noPadding>
                        <div className="p-4 font-mono text-xs space-y-4 text-gray-300">
                            <div>
                                <div className="text-gray-500 mb-1"># Test on YOUR code</div>
                                <div><span className="text-claude-ish">$</span> claudemem benchmark --full</div>
                            </div>
                            <div>
                                <div className="text-gray-500 mb-1"># Compare specific models</div>
                                <div><span className="text-claude-ish">$</span> claudemem benchmark --models "voyage-3,text-3-large"</div>
                            </div>
                        </div>
                    </TerminalWindow>
                </div>
        ...
        <div className="bg-[#111] rounded-2xl border border-white/10 p-8 md:p-12">
            <h3 className="text-2xl font-bold text-white mb-8 text-center">Summary: Why claudemem?</h3>
            <div className="overflow-x-auto">
                <table className="w-full text-left border-collapse font-mono text-sm">
                    <thead>
                        <tr className="border-b border-white/10">
                            <th className="py-4 px-4 text-gray-500 uppercase tracking-widest text-xs">If you need...</th>
                            <th className="py-4 px-4 text-claude-ish uppercase tracking-widest text-xs">claudemem delivers</th>
                        </tr>
                    </thead>
                    <tbody className="divide-y divide-white/5">
                        <tr><td className="py-4 px-4 text-gray-300">Terminal workflow</td><td className="py-4 px-4 text-white">Full CLI toolkit</td></tr>
                        <tr><td className="py-4 px-4 text-gray-300">Claude Code integration</td><td className="py-4 px-4 text-white">Native MCP server</td></tr>
                        <tr><td className="py-4 px-4 text-gray-300">Model flexibility</td><td className="py-4 px-4 text-white">Any embedding model (cloud or local)</td></tr>
                        <tr><td className="py-4 px-4 text-gray-300">Cost optimization</td><td className="py-4 px-4 text-white">Benchmark to find cheapest effective model</td></tr>
                        <tr><td className="py-4 px-4 text-gray-300">Air-gapped deployment</td><td className="py-4 px-4 text-white">100% local with Ollama</td></tr>
                        <tr><td className="py-4 px-4 text-gray-300">Zero extra API costs</td><td className="py-4 px-4 text-white">Use existing Claude Code subscription</td></tr>
                        <tr><td className="py-4 px-4 text-gray-300">Proof it works</td><td className="py-4 px-4 text-white">Built-in benchmarks on your actual code</td></tr>
                    </tbody>
                </table>
            </div>
            <div className="mt-8 text-center">
                <p className="text-gray-500 text-sm">Other tools pick models for you. We give you the choice — and the data to choose.</p>
            </div>
        </div>
...
const ResearchFooter: React.FC = () => (
    <div className="bg-[#050505] py-24 border-t border-white/5" id="research">
        <div className="max-w-5xl mx-auto px-6">
            <h3 className="text-2xl font-bold text-white mb-12 text-center">Research Behind the Approach</h3>
            
            <div className="grid md:grid-cols-3 gap-12 text-sm text-gray-400 leading-relaxed font-mono">
                <div className="space-y-4">
                    <h4 className="text-white font-bold uppercase tracking-widest text-xs border-b border-white/10 pb-2">Granularity</h4>
                    <p>
                        <strong className="text-claude-ish">JP Morgan's Meta-RAG (2025)</strong> proved that hierarchical retrieval outperforms flat approaches.
                    </p>
                ...
                <div className="space-y-4">
                    <h4 className="text-white font-bold uppercase tracking-widest text-xs border-b border-white/10 pb-2">PageRank</h4>
                    <p>
                        <strong className="text-claude-ish">Aider</strong> pioneered repo-maps using PageRank. We extend this to symbol-level granularity.
                    </p>
                    <p className="text-xs">
                        When context is limited, high-rank symbols (critical infrastructure) are prioritized over isolated utility functions.
                    </p>
                </div>

                <div className="space-y-4">
                    <h4 className="text-white font-bold uppercase tracking-widest text-xs border-b border-white/10 pb-2">Evaluation</h4>
                    <p>
                        We use <strong className="text-claude-ish">LLM-as-a-Judge</strong> (GPT-4) which achieves 85% alignment with human judgment—higher than human-to-human agreement (81%).
                    </p>
                    <p className="text-xs">
            ...
            <div className="mt-20 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div className="flex gap-6">
                    <a href="https://arxiv.org/abs/2410.17435" className="text-xs font-bold text-white hover:text-claude-ish transition-colors">Read Meta-RAG Paper</a>
                    <a href="https://aider.chat/docs/repomap.html" className="text-xs font-bold text-white hover:text-claude-ish transition-colors">Read Aider Docs</a>
                </div>
            </div>
        </div>
    </div>
...
const VisualCriticalPath = () => (
    <div className="w-full h-full flex items-center justify-center relative animate-fadeIn">
        ...
        <svg className="absolute inset-0 w-full h-full pointer-events-none z-0">
            ...
            <path d="M50% 25% L 28% 40%" stroke="#333" strokeWidth="2" strokeDasharray="4" />
            <path d="M50% 25% L 72% 40%" stroke="#333" strokeWidth="2" strokeDasharray="4" />
            
            {/* Active Path */}
            <path d="M50% 25% L 50% 38%" stroke="#f59e0b" strokeWidth="3" className="animate-draw" />
            <path d="M50% 60% L 50% 80%" stroke="#f59e0b" strokeWidth="3" className="animate-draw" style={{animationDelay: '0.5s'}} />
        </svg>
    </div>
);
...
const VisualDeadCode = () => (
    <div className="w-full max-w-sm space-y-3 font-mono text-xs animate-fadeIn">
        ...
        <div className="bg-[#151515] p-3 rounded border border-white/10 flex justify-between items-center opacity-40 relative overflow-hidden group">
            <span className="text-gray-500 line-through decoration-red-500/50">function legacyAuth_v1()</span>
        ...
        <div className="bg-[#151515] p-3 rounded border border-white/10 flex justify-between items-center opacity-40 relative">
             <span className="text-gray-500 line-through decoration-red-500/50">var temp_fix_2023 = ...</span>
             <span className="text-red-500 text-[10px] font-bold">DEAD</span>
             <div className="absolute inset-0 bg-red-500/5"></div>
        </div>
    </div>
...
const VisualPatterns = () => (
    <div className="w-full max-w-md font-mono text-xs animate-fadeIn">
        ...
        <div className="bg-[#111] border border-gray-800 rounded p-4 space-y-2 relative">
             <div className="text-purple-400">const calculateTotal = (items) =&gt; {'{'}</div>
             <div className="pl-4 text-gray-300">return items.reduce((acc, item) =&gt; acc + item, 0);</div>
             <div className="text-purple-400">{'}'}</div>
        ...
        <div className="mt-4 opacity-50">
             ...
             <div className="text-gray-600 line-through">function calc(i) {'{'} var sum=0; ... {'}'}</div>
        </div>
    </div>
);
...
const VisualIntent = () => (
    <div className="w-full max-w-md relative animate-fadeIn">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-[#0c0c0c] border border-red-500/50 p-4 rounded-xl shadow-[0_0_30px_rgba(239,68,68,0.2)] w-[110%] animate-float">
             <div className="text-[10px] text-red-500 font-bold uppercase tracking-wider mb-1">True Intent Detected</div>
...
const BoltIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
);
const SkullIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="12" r="1"/><circle cx="15" cy="12" r="1"/><path d="M8 20v2h8v-2"/><path d="M12.5 17l-.5-4"/><path d="M16 20a2 2 0 0 0 1.56-3.25 8 8 0 1 0-11.12 0A2 2 0 0 0 8 20"/></svg>
);
const LinkIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/></svg>
);
const BrainIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 5a3 3 0 1 0-5.997.125 4 4 0 0 0-2.526 5.77 4 4 0 0 0 .556 6.588A4 4 0 1 0 12 18Z"/><path d="M12 5a3 3 0 1 1 5.997.125 4 4 0 0 1 2.526 5.77 4 4 0 0 1-.556 6.588A4 4 0 1 1 12 18Z"/><path d="M15 13a4.5 4.5 0 0 1-3-4 4.5 4.5 0 0 1-3 4"/><path d="M17.599 6.5a3 3 0 0 0 .399-1.375"/><path d="M6.003 5.125A3 3 0 0 0 6.401 6.5"/><path d="M3.477 10.896a4 4 0 0 1 .585-.396"/><path d="M19.938 10.5a4 4 0 0 1 .585.396"/><path d="M6 18a4 4 0 0 1-1.937-.5"/><path d="M19.937 17.5A4 4 0 0 1 18 18"/></svg>
);
const TargetIcon = () => (
...
const DnaIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 15c6.667-6 13.333 0 20-6"/><path d="M9 22c1.798-1.998 2.518-3.995 2.807-5.993"/><path d="M15 2c-1.798 1.998-2.518 3.995-2.807 5.993"/><path d="M17 12a5.702 5.702 0 0 1-.92 3.106"/></svg>
);
