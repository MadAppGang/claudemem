                    ...
                    <table className="w-full text-left border-collapse font-mono text-xs md:text-sm border border-white/10 rounded-lg overflow-hidden">
                        ...
                        <tbody className="divide-y divide-white/5 text-gray-400 bg-[#0c0c0c]">
                            <tr>
                                ...
                                <td className="p-4">Normalized Discounted Cumulative Gain — overall ranking quality. Higher means relevant results appear higher.</td>
                            </tr>
                            <tr>
                                <td className="p-4 font-bold text-white">MRR</td>
                                <td className="p-4">Mean Reciprocal Rank — on average, how high does the correct result appear? MRR of 0.5 means correct answer is typically 2nd.</td>
                            </tr>
                            <tr>
