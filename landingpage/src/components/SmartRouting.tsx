				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative z-20">
						...
						<div className="p-6 flex-1 flex flex-col">
							...
							<div className="text-sm font-mono text-gray-400 mb-6 flex-1">
								<p className="mb-4 text-gray-500">
									Direct passthrough to Anthropic's API. Uses your existing
									credits or Pro plan.
								</p>
						...
						<div className="p-6 flex-1 flex flex-col">
							...
							<div className="text-sm font-mono text-gray-400 mb-6 flex-1">
								<p className="mb-4 text-gray-500 leading-relaxed">
									OpenRouter consistently offers high-quality models at no cost.
									Not trials. Not limited versions. Real models from Google,
									xAI, DeepSeek, Meta, Microsoft, and more.
								</p>
								<ul className="space-y-2">
									<li className="flex items-center gap-2 text-white">
					...
					>
						...
						<div className="p-6 flex-1 flex flex-col">
							...
							<div className="text-sm font-mono text-gray-400 mb-6 flex-1">
								<p className="mb-4 text-gray-500">
									Use top-tier reasoning models from other providers. Paid per
									token.
								</p>
								<ul className="space-y-2">
									<li className="flex items-center gap-2 text-white">
						...
						>
							...
							<div className="flex items-center gap-2 mt-2">
								<span className="text-gray-400">
									These aren't trials. They're real models. Pick one and start
									coding.
								</span>
							</div>
						</div>
