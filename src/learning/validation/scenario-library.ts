...
const BUILT_IN_SCENARIOS: ValidationScenario[] = [
	...
	// ============================================================================
	{
		...
		description: "Debug and fix a race condition in the data fetching logic",
		difficulty: 4,
		category: "debugging",
	...
	// ============================================================================
	{
		...
		description: "Write comprehensive unit tests for the UserService class",
		difficulty: 3,
		category: "testing",
		...
		correctionPoints: [
			{
				...
				correction: "Tests should be in src/services/__tests__/user.test.ts",
				expectedRecovery: ["Write"],
			},
		],
	...
	// ============================================================================
	{
		...
		description: "Add comprehensive JSDoc comments to the API service module",
		difficulty: 2,
	...
	// ============================================================================
	{
		...
		correctionPoints: [
			...
			},
			{
				...
				correction: "The avatar should have a default placeholder image",
				expectedRecovery: ["Edit"],
			},
		],
	...
	// ============================================================================
	{
		...
		description: "Handle npm install failure and find alternative solution",
		difficulty: 3,
		...
		successCriteria: [{ type: "no_errors", excludeTypes: ["npm WARN"] }],
	},
	...
	// ============================================================================
	{
		...
		description: "Identify and fix SQL injection vulnerability in user search",
		difficulty: 4,
		category: "security",
